			...
			array(
				...
				'fields'   => array(
					...
					array(
						...
						'instructions'  => 'Total review count shown next to the rating, e.g. 42.',
						'type'          => 'text',
						'default_value' => '',
					),
					array(
					...
					array(
						'key'           => 'field_testi_1_rating',
						'name'          => 'testimonial_1_rating',
						'label'         => 'Testimonial 1 — Star rating',
						'instructions'  => 'Stars shown on this review (1–5). Defaults to 5.',
						'type'          => 'number',
						'default_value' => 5,
						'min'           => 1,
						'max'           => 5,
					...
					array(
						'key'           => 'field_testi_2_rating',
						'name'          => 'testimonial_2_rating',
						'label'         => 'Testimonial 2 — Star rating',
						'instructions'  => 'Stars shown on this review (1–5). Defaults to 5.',
						'type'          => 'number',
						'default_value' => 5,
						'min'           => 1,
					...
					array(
						'key'           => 'field_testi_3_rating',
						'name'          => 'testimonial_3_rating',
						'label'         => 'Testimonial 3 — Star rating',
						'instructions'  => 'Stars shown on this review (1–5). Defaults to 5.',
						'type'          => 'number',
						'default_value' => 5,
						'min'           => 1,
