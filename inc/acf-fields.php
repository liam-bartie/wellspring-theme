			...
			array(
				...
				'fields'                => array(
					...
					array(
						...
						'label'        => 'Sub-heading',
						'instructions' => 'Short line under the heading. Leave blank to fall back to the page excerpt.',
						'type'         => 'textarea',
						'rows'         => 2,
					),
					array(
						...
						'instructions'  => 'Leave empty and the featured image is used instead. Kept separate because the featured image is also this page&rsquo;s thumbnail on parent listings and case cards, and a wide hero crop makes a poor card. Cropped to 1920&times;800.',
						'type'          => 'image',
						'return_format' => 'array',
						'preview_size'  => 'medium',
					),
					array(
						...
						'instructions'  => 'Which part of the image to keep in frame. The hero crop is wide, so a tall photo loses its subject unless you point at it.',
						'type'          => 'select',
						'choices'       => array(
