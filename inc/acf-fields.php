			...
			array(
				...
				'fields'                => array(
					array(
						...
						'name'         => 'page_h1',
						'label'        => 'Heading (H1)',
						'instructions' => 'Defaults to the page title.',
						'type'         => 'text',
					),
					array(
						...
						'label'        => 'Sub-heading',
						'instructions' => 'Defaults to the page excerpt.',
						'type'         => 'textarea',
						'rows'         => 2,
					),
					array(
						...
						'instructions'  => 'Defaults to the featured image. Cropped to 1920&times;800.',
						'type'          => 'image',
						'return_format' => 'array',
						'preview_size'  => 'medium',
					),
						...
						'layouts'      => array(
							...
							'layout_home_cases' => array(
								...
								array(
									...
									'instructions'  => 'Pick up to 3. Leave empty to show the 3 most recent published cases.',
									'max'           => 3,
									'type'          => 'relationship',
									'post_type'     => array( 'clinic_case' ),
									'filters'       => array( 'search' ),
